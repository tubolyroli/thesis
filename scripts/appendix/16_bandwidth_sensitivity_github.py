...
def main():
    ...
    print("Loading data for GitHub bandwidth sensitivity...")
    df_full = pd.read_csv(MAIN_ANALYSIS_DATA)
    # Focus only on matched GitHub libraries
    ...
    for h in bandwidths:
        ...
        res = run_rdrobust_est(df_gh, outcome, h=h, donut_weeks=DONUT_WEEKS, label=f"GitHub BW: {h}w")
        results.append(res)
    ...
    print("\n=========================================")
    print("  GITHUB BANDWIDTH SENSITIVITY SUMMARY   ")
    print("=========================================\n")
