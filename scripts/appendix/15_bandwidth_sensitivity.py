...
from config import MAIN_ANALYSIS_DATA, RESULTS_ROBUSTNESS, FIG_ROBUSTNESS, DONUT_WEEKS, MIN_DOWNLOADS_FILTER, BW_GRID
...
def main():
    ...
    # Save the table
    results_df.to_csv(RESULTS_ROBUSTNESS / "sensitivity_bandwidth_post_ai.csv", index=False)
    print(f"Saved sensitivity results to {RESULTS_ROBUSTNESS / 'sensitivity_bandwidth_post_ai.csv'}")
    ...
    plt.tight_layout()
    plot_path = FIG_ROBUSTNESS / "sensitivity_bandwidth_post_ai.png"
